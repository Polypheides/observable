...
object Overlay : ClientBridge, WorldRenderer {
    ...
    override fun render(stack: Matrix4fStack, bufferSource: MultiBufferSource, camera: Vec3, modelViewMatrix: Matrix4fc, delta: DeltaTracker, collector: SubmitNodeCollector, cameraState: CameraRenderState) {
